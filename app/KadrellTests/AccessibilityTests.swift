...
final class AccessibilityTests: XCTestCase {
    ...
    func testCellHeader() {
        ...
        XCTAssertEqual(buttons.map { $0.accessibilityLabel() ?? "" }, ["Alpha, nicht gestartet, Projekt, master", "Zoomen", "Aus Ansicht nehmen", "Umbenennen", "Schließen"])
        XCTAssertTrue(buttons[3].accessibilityPerformPress())
